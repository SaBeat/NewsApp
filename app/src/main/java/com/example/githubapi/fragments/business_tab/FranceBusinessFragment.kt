...
import kotlinx.android.synthetic.main.fragment_france_news.*

class FranceBusinessFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_france_news, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        initRecycler()
        getData(Utils.countryFrance, Utils.API_KEY, Utils.categoryBusiness)
    }

    private fun initRecycler() {
        recyclerView_france.apply {
