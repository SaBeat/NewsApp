package com.example.githubapi.fragments.business_tab
...
import kotlinx.android.synthetic.main.fragment_turkey_news.*


class TurkeyBusinessFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_turkey_news, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        initRecycler()
        getData(Utils.countryTurkey, Utils.API_KEY, Utils.categoryBusiness)
    }

    private fun initRecycler() {
        recyclerView_turkey.apply {
